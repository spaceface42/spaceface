    ...
    public async initScrollDeck(): Promise<void> {
        ...
        try {
            ...
            this.scrollDecks = containers.map((container) => {
                const instance = new ScrollDeck(container, { ...scrollDeck });
                instance.ready?.then?.(() => {});
                return instance;
            });
